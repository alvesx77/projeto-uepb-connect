    ...
    public SecurityFilterChain securityFilterChain (HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET,"/vagas/salvas").authenticated()
                        .requestMatchers(HttpMethod.GET,"/vagas/{id}").authenticated()
                        .requestMatchers(HttpMethod.GET,"/paginas/retornarVagasDashboard").authenticated()
                        .requestMatchers(HttpMethod.GET,"/paginas/adicionarVagas/{area}").authenticated()
                        .requestMatchers(HttpMethod.POST,"/candidaturas/{idVaga}").authenticated()
                        .requestMatchers(HttpMethod.GET,"/vagas-salvas/{idVaga}").authenticated()
                        .requestMatchers(HttpMethod.POST,"/vagas-salvas/{idVaga}").authenticated()
                        .requestMatchers(HttpMethod.GET,"/vagas-salvas/detalhes").authenticated()
                        .anyRequest()
                        .authenticated()
